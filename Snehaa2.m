...
Max_SNR=40;
Rs=.5^.5;
hConvEnc = comm.ConvolutionalEncoder(poly2trellis([7 7 7], [171 126  52 111 ; 63 165 141 74 ; 142 121 124 152]));
% hConvEnc.PuncturePatternSource = 'Property';
% hConvEnc.PuncturePattern = [1;1;0;1;1;0];
hVitDec = comm.ViterbiDecoder(poly2trellis([7 7 7], [171 126  52 111 ; 63 165 141 74 ; 142 121 124 152]), ...
  'InputFormat', 'Hard');
% hVitDec.PuncturePatternSource =  'Property';
% hVitDec.PuncturePattern = hConvEnc.PuncturePattern;
hVitDec.TracebackDepth = 34;
...
x=0:5:Max_SNR;
semilogy(x+10*log10(1/2),BER,'color',randi([0 1],1,3),'linewidth',2.5);
grid on
