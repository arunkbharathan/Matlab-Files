...
i=1;
subplot(4,1,i);
plot(real(ofdm_symbols_tx(i:l)),'-ko');i=i+1;
title('OFDM symbols / \musec');grid on;
subplot(4,1,i);
plot((l+1:i*l),real(ofdm_symbols_tx(l+1:i*l)),'-ko');
i=i+1;grid on;
subplot(4,1,i);
plot((i-1)*l+1:i*l,real(ofdm_symbols_tx((i-1)*l+1:i*l)),'-ko');
i=i+1;grid on;
subplot(4,1,i);
plot((i-1)*l+1:i*l,real(ofdm_symbols_tx((i-1)*l+1:i*l)),'-ko');
grid on;
